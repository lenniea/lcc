...
reg: ADDI4(reg,rc)   "addu r%c,r%0,%1\n"  1
reg: ADDP4(reg,rc)   "addu r%c,r%0,%1\n"  1
reg: ADDU4(reg,rc)   "addu r%c,r%0,%1\n"  1
reg: BANDI4(reg,rc)  "and r%c,r%0,%1\n"   1
reg: BORI4(reg,rc)   "or r%c,r%0,%1\n"    1
reg: BXORI4(reg,rc)  "xor r%c,r%0,%1\n"   1
reg: BANDU4(reg,rc)  "and r%c,r%0,%1\n"   1
reg: BORU4(reg,rc)   "or r%c,r%0,%1\n"    1
reg: BXORU4(reg,rc)  "xor r%c,r%0,%1\n"   1
reg: SUBI4(reg,rc)   "subu r%c,r%0,%1\n"  1
reg: SUBP4(reg,rc)   "subu r%c,r%0,%1\n"  1
reg: SUBU4(reg,rc)   "subu r%c,r%0,%1\n"  1
rc5: CNSTI4         "%a"                range(a,0,31)
rc5: reg            "r%0"

reg: LSHI4(reg,rc5)  "sll r%c,r%0,%1\n"  1
reg: LSHU4(reg,rc5)  "sll r%c,r%0,%1\n"  1
reg: RSHI4(reg,rc5)  "sra r%c,r%0,%1\n"  1
reg: RSHU4(reg,rc5)  "srl r%c,r%0,%1\n"  1
reg: BCOMI4(reg)  "not r%c,r%0\n"   1
reg: BCOMU4(reg)  "not r%c,r%0\n"   1
reg: NEGI4(reg)   "negu r%c,r%0\n"  1
reg: LOADI1(reg)  "move r%c,r%0\n"  move(a)
reg: LOADU1(reg)  "move r%c,r%0\n"  move(a)
reg: LOADI2(reg)  "move r%c,r%0\n"  move(a)
reg: LOADU2(reg)  "move r%c,r%0\n"  move(a)
reg: LOADI4(reg)  "move r%c,r%0\n"  move(a)
reg: LOADP4(reg)  "move r%c,r%0\n"  move(a)
reg: LOADU4(reg)  "move r%c,r%0\n"  move(a)
...
reg: CVII4(reg)  "sll r%c,r%0,8*(4-%a); sra r%c,r%c,8*(4-%a)\n"  2
...
reg: CVIF4(reg)  "mtc1 r%0,$f%c; cvt.s.w $f%c,$f%c\n"  2
reg: CVIF8(reg)  "mtc1 r%0,$f%c; cvt.d.w $f%c,$f%c\n"  2
reg: CVFI4(reg)  "trunc.w.s $f2,$f%0,r%c; mfc1 r%c,$f2\n"  (a->syms[0]->u.c.v.i==4?2:LBURG_MAX)
reg: CVFI4(reg)  "trunc.w.d $f2,$f%0,r%c; mfc1 r%c,$f2\n"  (a->syms[0]->u.c.v.i==8?2:LBURG_MAX)
stmt: LABELV  "%a:\n"
stmt: JUMPV(acon)  "b %0\n"   1
stmt: JUMPV(reg)   ".cpadd r%0\nj r%0\n"  !pic
stmt: JUMPV(reg)   "j r%0\n"  pic
stmt: EQI4(reg,reg)  "beq r%0,r%1,%a\n"   1
stmt: EQU4(reg,reg)  "beq r%0,r%1,%a\n"   1
stmt: GEI4(reg,reg)  "bge r%0,r%1,%a\n"   1
stmt: GEU4(reg,reg)  "bgeu r%0,r%1,%a\n"  1
stmt: GTI4(reg,reg)  "bgt r%0,r%1,%a\n"   1
stmt: GTU4(reg,reg)  "bgtu r%0,r%1,%a\n"  1
stmt: LEI4(reg,reg)  "ble r%0,r%1,%a\n"   1
stmt: LEU4(reg,reg)  "bleu r%0,r%1,%a\n"  1
stmt: LTI4(reg,reg)  "blt r%0,r%1,%a\n"   1
stmt: LTU4(reg,reg)  "bltu r%0,r%1,%a\n"  1
